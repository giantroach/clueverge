 ...
 * clueverge implementation : © Tomoki Motohashi <tomoki.motohashi@takoashi.com>
 *
 ...
 * clueverge.js
 *
 * clueverge user interface script
 *
 * In this file, you are describing the logic of your user interface, in Javascript language.
 *
 */

const appName = 'clueverge';
let i18n;
...
define([
  ...
  let vue = null;
  return declare('bgagame.clueverge', ebg.core.gamegui, {
    constructor: function () {
      console.log('clueverge constructor');
...
*/
    ...
    /* Example:
        ...
        onMyMethodToCall1: function( evt )
        {
            ...
            this.ajaxcall( "/clueverge/clueverge/myAction.html", {
                                                                    lock: true,
                                                                    myArgument1: arg1,
                                                                    myArgument2: arg2,
                                                                    ...
